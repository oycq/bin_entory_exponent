...
class Net(nn.Module):
    def __init__(self, input_size=784):
        ...
        #self.cnn1 = CNNLayer(32,3,6,2,32) #14,14,32,6272
        #self.cnn2 = CNNLayer(14,32,6,1,64) #9,9,64,5184
        #self.cnn3 = CNNLayer(9,64,3,1,64) #6,6,128,4608
        #self.cnn4 = CNNLayer(6,64,3,1,128) #4,4,256,4096
        #self.cnn5 = CNNLayer(4,128,4,1,4000) #1,1,4000,4000
        self.cnn1 = CNNLayer(32,8,6,2,8) #14,14,32,6272
        self.cnn2 = CNNLayer(14,8,14,1,500) #9,9,64,5184
